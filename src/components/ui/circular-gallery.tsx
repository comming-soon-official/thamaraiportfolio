    ...
    return (
        <div
            className={cn(
                ...
                'min-h-[500px] bg-gradient-to-b from-transparent to-background/50',
...
// Export configs for easy theme customization
export const galleryVariants = {
    ...
    social: {
        ...
        textColor: '#E5E7EB',
        borderRadius: 0.1,
        font: 'medium 24px DM Sans'
    },
    minimal: {
        bend: 1,
        textColor: '#9CA3AF',
        borderRadius: 0.15,
        font: 'normal 20px DM Sans'
    }
}
